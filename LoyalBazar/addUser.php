				...
				<div class="row">
					<div class="col-md-12">
						<form method="post"  action="validateAddUser.php">
							<div style="margin-left: 11%;color: green;font-size: 30px;font-weight: bold;">
								<p>Add New Client:</p>
							...
							<div class="input-group" style="width:40%;">
								<button type="submit" id="addUser" name="addUser" class="btn btn-success form-control"><span><i class="fa fa-user-plus"></i></span>&nbsp;&nbsp;Add User</button>
							</div>
						</form>
					</div>
				</div>
