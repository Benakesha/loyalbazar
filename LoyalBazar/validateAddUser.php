<?php
	...
	if(isset($_POST['addUser'])){		
			...
			while ($row=mysqli_fetch_assoc($res)) {
				...
				$sql="INSERT INTO loyal_user_client VALUES(null,'$txtUserName','$txtPassword','$txtConfirmPassword','$userType',$userId)";
				mysqli_query($conn,$sql) or die(mysqli_error($conn));
				
				$sql1="INSERT INTO loyal_user VALUES(null,'$txtUserName','$txtPassword',0,'0',$userId,'$userType',0)";
